...
auto main() -> int
{
    ...
    for (const auto& file : files_to_test)
    {
        ...
        result_is_ok = (nist::cavs::test_vectors_aes_mmt<boost::crypt::aes_cipher_mode::ecb, boost::crypt::aes128<boost::crypt::aes_cipher_mode::ecb>>(test_vectors) && result_is_ok);
